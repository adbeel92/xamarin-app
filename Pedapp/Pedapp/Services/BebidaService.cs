...
namespace Pedapp.Services
{
    public class BebidaService
    {
        ...
        public bool createDrink(string name, int alcohol_type_id, string how_to_prepare, string filePath)
        {
            var data = _restClient.createDrink(name, alcohol_type_id, how_to_prepare, filePath);
